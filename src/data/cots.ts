...
export const cots: DiwanCotProduct[] = [
  {
    ...
    isBestSeller: true,
    image: "https://images.unsplash.com/photo-0dJA53GaIl0?auto=format&fit=crop&q=80&w=800", // We reuse the placeholder for now
    warranty: "10 years",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo--R2uNyGmeM4?auto=format&fit=crop&q=80&w=800",
    warranty: "10 years",
    sizes: "Custom sized to your exact mattress",
  ...
  },
  {
    ...
    isBestSeller: true,
    image: "https://images.unsplash.com/photo-DE9MM2voqKc?auto=format&fit=crop&q=80&w=800",
    warranty: "5 years",
  ...
  },
  {
    ...
    leadTime: "8-10 days",
    installationCharge: 800,
    image: "https://images.unsplash.com/photo-7cMA-REKnY4?auto=format&fit=crop&q=80&w=800",
    warranty: "5 years",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-gVKmonDbotU?auto=format&fit=crop&q=80&w=800",
    warranty: "1 year",
