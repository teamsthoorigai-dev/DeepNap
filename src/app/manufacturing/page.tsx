        ...
        <div className="max-w-[1280px] mx-auto px-gutter md:px-gutter-tablet lg:px-gutter-desktop flex flex-col gap-20 lg:gap-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div className="order-1 lg:order-2 relative aspect-[4/3] rounded-2xl overflow-hidden bg-[#EFE5D7]">
              <Image src="https://images.unsplash.com/photo-1554995207-c18c203602cb?auto=format&fit=crop&q=80&w=800" alt="Materials In" fill className="object-cover" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-[#EFE5D7]">
              <Image src="https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&q=80&w=800" alt="Cutting" fill className="object-cover" />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div className="order-1 lg:order-2 relative aspect-[4/3] rounded-2xl overflow-hidden bg-[#EFE5D7]">
              <Image src="https://images.unsplash.com/photo-1505693314120-0d443867891c?auto=format&fit=crop&q=80&w=800" alt="Layering" fill className="object-cover" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-[#EFE5D7]">
              <Image src="https://images.unsplash.com/photo-1536882240095-0379873feb4e?auto=format&fit=crop&q=80&w=800" alt="Quilting and Stitching" fill className="object-cover" />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            ...
            <div className="order-1 lg:order-2 relative aspect-[4/3] rounded-2xl overflow-hidden bg-[#EFE5D7]">
              <Image src="https://images.unsplash.com/photo-1540518614846-7eded433c457?auto=format&fit=crop&q=80&w=800" alt="Finishing" fill className="object-cover" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="bg-surface-white rounded-2xl overflow-hidden border border-hairline hover:border-primary/30 transition-colors">
              <div className="relative h-48 w-full bg-[#EFE5D7]">
                <Image src="https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&q=80&w=800" alt="Rubberised Coir" fill className="object-cover mix-blend-multiply" />
              </div>
            ...
            <div className="bg-surface-white rounded-2xl overflow-hidden border border-hairline hover:border-primary/30 transition-colors">
              <div className="relative h-48 w-full bg-[#EFE5D7]">
                <Image src="https://images.unsplash.com/photo-1631679706909-1844bbd07221?auto=format&fit=crop&q=80&w=800" alt="Natural Latex" fill className="object-cover mix-blend-multiply" />
              </div>
              <div className="p-6 md:p-8">
            ...
            <div className="bg-surface-white rounded-2xl overflow-hidden border border-hairline hover:border-primary/30 transition-colors">
              <div className="relative h-48 w-full bg-[#EFE5D7]">
                <Image src="https://images.unsplash.com/photo-1578683010236-d716f9a3f461?auto=format&fit=crop&q=80&w=800" alt="HR Foam" fill className="object-cover mix-blend-multiply" />
              </div>
              <div className="p-6 md:p-8">
            ...
            <div className="bg-surface-white rounded-2xl overflow-hidden border border-hairline hover:border-primary/30 transition-colors">
              <div className="relative h-48 w-full bg-[#EFE5D7]">
                <Image src="https://images.unsplash.com/photo-1554995207-c18c203602cb?auto=format&fit=crop&q=80&w=800" alt="Memory Foam" fill className="object-cover mix-blend-multiply" />
              </div>
              <div className="p-6 md:p-8">
            ...
            <div className="bg-surface-white rounded-2xl overflow-hidden border border-hairline hover:border-primary/30 transition-colors md:col-span-2 lg:col-span-2">
              <div className="flex flex-col md:flex-row h-full">
                <div className="relative h-48 md:h-full md:w-2/5 bg-[#EFE5D7] border-b md:border-b-0 md:border-r border-hairline">
                  <Image src="https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&q=80&w=800" alt="Pocket Springs" fill className="object-cover mix-blend-multiply" />
                </div>
